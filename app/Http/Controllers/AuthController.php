...
class AuthController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // validator untuk request
        $validtor = Validator::make($request->all(), $roles, $messages);
        if ($validtor->fails()) {
            return redirect()->back()->withErrors($validtor)->withInput($request->all());
        }
        $data = [
    ...
    public function register(Request $request)
    {
        ...
        $messages = [
            ...
            'username.min'          => 'Username 3 karakter',
